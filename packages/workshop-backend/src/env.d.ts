...
// The private binding uses standard HTTP fetch for streaming inference and RPC only for sanitized
// lifecycle management. The relay class lives in an independently merged package, so this
// structural intersection keeps the packages typed without coupling backend to that class.
